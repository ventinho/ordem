...
<head>
  ...
  <title>Administração Cor d´Alma | <?php $this->renderSection('titulo');?></title>
  <!-- General CSS Files -->
  <link rel="stylesheet" href="<?php echo site_url('recursos/'); ?>assets/css/app.min.css">
  <!-- Template CSS -->
  <link rel="stylesheet" href="<?php echo site_url('recursos/'); ?>assets/css/style.css">
  <link rel="stylesheet" href="<?php echo site_url('recursos/'); ?>assets/css/components.css">
  <!-- Custom style CSS -->
  <link rel="stylesheet" href="<?php echo site_url('recursos/'); ?>assets/css/custom.css">
  <link rel='shortcut icon' type='image/x-icon' href='<?php echo site_url('recursos/'); ?>assets/img/favicon.ico' />
...
<body>
    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          <?php echo date('Y'); ?> - Cor d'alma - Todos os direitos reservados
        </div>
  ...
  <script src="<?php echo site_url('recursos/'); ?>assets/js/jquery.min.js"></script>
  <script src="<?php echo site_url('recursos/'); ?>assets/js/app.min.js"></script>
  <!-- JS Libraies -->
  <script src="<?php echo site_url('recursos/'); ?>assets/bundles/apexcharts/apexcharts.min.js"></script>
  <!-- Page Specific JS File -->
  <script src="<?php echo site_url('recursos/'); ?>assets/js/page/index.js"></script>
  <!-- Template JS File -->
  <script src="<?php echo site_url('recursos/'); ?>assets/js/scripts.js"></script>
  <!-- Custom JS File -->
  <script src="<?php echo site_url('recursos/'); ?>assets/js/custom.js"></script>
